...
const Products = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#FEFCF9] dark:bg-slate-900 pt-20">
  ...
  return (
    <div className="min-h-screen bg-[#FEFCF9] dark:bg-slate-900 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        {/* Controls Bar */}
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 p-4 bg-[#FEFCF9] dark:bg-slate-800 rounded-2xl shadow-sm border border-amber-100/50 dark:border-slate-700">
        ...
        <div className="drawer drawer-end lg:hidden">
          ...
          <div className="drawer-side z-50">
            ...
            <div className="w-80 min-h-full bg-[#FEFCF9] dark:bg-slate-800 p-6">
